...
export default class WebGL {
    ...
    init(): void {
        ...
        //         // Scaling
        //         particles[i].scale.set(Math.sin(framesCount * 0.00001 * i), Math.sin(framesCount * 0.00001 * i), Math.sin(framesCount * 0.00001 * i));
    ...
    setMesh() {
        ...
        const geo = new THREE.EdgesGeometry(this.three.mesh.geometry);
        const mat = new THREE.LineBasicMaterial({ color: 0xbbbbbb, linewidth: 2 });
        const wireFrame = new THREE.LineSegments(geo, mat);
        this.three.mesh.add(wireFrame);
    }
    setLoading() {
        // this.setMesh();
        // glTF形式の3Dモデルを読み込む
        ...
        loader.load(this.srcObj, (obj) => {
            ...
            this.three.redraw.scale.set(1.5, 1.5, 1.5);
    ...
    rendering(): void {
        ...
        // オブジェクトを回転
        // this.three.mesh.rotation.y += 0.001;
